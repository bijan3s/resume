...
export const starSkillsData: StarSkill[] = [
  ...
  { name: 'Tailwind CSS & Material UI', category: 'Styling & UI', rating: 5 },
  {
    name: 'Automated Testing (Playwright, Jest, Vitest)',
    category: 'Quality Assurance',
    rating: 5,
  },
  {
    name: 'Real-Time Streaming (NATS, JetStream, WebSockets)',
    category: 'Real-Time Systems',
    rating: 5,
  },
  { name: 'Node.js, Express & NestJS', category: 'Backend', rating: 4 },
  ...
  {
    name: 'Observability & Tooling (Grafana, Vector, Docker)',
